...
// Weapon represents the player's weapon
type Weapon struct {
	DirectionX    float64 // Direction vector X component
	DirectionY    float64 // Direction vector Y component
	Length        float64 // Length of the weapon
	Angle         float64 // Current angle in radians
	Swinging      bool    // Whether the weapon is currently swinging
	SwingProgress float64 // 0 to 1, progress of swing animation
	SwingSpeed    float64 // Speed of swing animation
	Damage        float64 // Damage dealt by the weapon
