...
一款受 *Terraria* 啟發的 2D 沙盒冒險遊戲，但建立在**六角網格**上。

探索世界、採礦資源、建造建築、製作物品、戰鬥敵人並生存 — 一切都在美麗的六角磚塊中。

## 遊戲特色

### ✅ **完整特色**
- **六角世界生成** - 帶有生態的程序生成世界
- **採礦與製作** - 基於工具的採礦，具有不同的材料速度
- **方塊放置** - 右鍵放置方塊並有預覽效果
- **物品欄系統** - 32 格物品欄與快捷欄（9 格）
- **戰鬥系統** - 生命值/傷害系統與攻擊動畫
- **晝夜循環** - 動態照明與時間進程
- **天氣效果** - 雨、雪與風暴系統
- **保存/載入系統** - 持久世界狀態與自動保存
